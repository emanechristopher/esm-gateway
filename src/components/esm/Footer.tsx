    ...
    <footer className="border-t border-border/60 bg-card">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-12 grid md:grid-cols-3 gap-8 items-start">
        ...
        <div className="text-sm text-muted-foreground space-y-2">
          <div className="text-xs uppercase tracking-[0.2em] text-foreground/80 mb-3">Navigation</div>
          <a href="#about" className="block hover:text-primary">À propos</a>
          <a href="#services" className="block hover:text-primary">Services</a>
          <a href="#partners" className="block hover:text-primary">Partenaires</a>
          <a href="#cases" className="block hover:text-primary">Réussites</a>
          <a href="#contact" className="block hover:text-primary">Contact</a>
        </div>
        <div className="text-sm text-muted-foreground space-y-2">
          <div className="text-xs uppercase tracking-[0.2em] text-foreground/80 mb-3">Coordonnées</div>
