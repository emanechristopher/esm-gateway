      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
          ...
          <p className="text-muted-foreground max-w-md">
            Quelques parcours, parmi d'autres, qui témoignent de la précision et de l'humanité de
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {cases.map((c, i) => (
            <article
              key={c.title}
              className="bg-card rounded-2xl border border-border/60 shadow-[var(--shadow-card)] flex flex-col overflow-hidden hover:shadow-[var(--shadow-elegant)] hover:-translate-y-1 transition-all"
            >
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <h3 className="mt-6 font-display text-2xl text-primary-deep leading-snug">
                  {c.title}
                </h3>
