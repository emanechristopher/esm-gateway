    ...
    <section id="about" className="py-24 lg:py-32">
      <div className="max-w-4xl mx-auto px-6 lg:px-10 space-y-6 text-center">
        ...
        <p className="text-lg text-foreground/80 leading-relaxed">
          Fondée à Libreville par{" "}
          <strong className="text-primary-deep">Georgia Corine AVOMO EWAGA</strong>,
          <em> Éclat Solutions Médical</em> est une société d'assistance médicale haut de gamme
          dédiée aux patients africains en quête de soins de référence à l'étranger.
        </p>
        <p className="text-lg text-foreground/80 leading-relaxed">
          Nous orchestrons chaque étape du parcours de soin — de l'évaluation du dossier à la
          convalescence — en partenariat avec les meilleurs établissements de Turquie, du Maroc et
          de France.
        </p>
