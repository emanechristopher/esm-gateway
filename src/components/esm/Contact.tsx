        ...
        <div className="bg-card rounded-3xl border border-border/60 shadow-[var(--shadow-elegant)] overflow-hidden grid lg:grid-cols-2">
          <div className="p-10 lg:p-14">
            ...
            <p className="mt-5 text-muted-foreground">
              Notre équipe vous répond avec discrétion sous 24 heures. Premier échange confidentiel
              et sans engagement.
            </p>
            <div className="mt-10 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="tel:+24166940740"
                    className="block text-foreground font-medium mt-0.5 hover:text-primary"
                  >
                    +241 66 94 07 40
                  </a>
                  <a
                    href="tel:+905445649917"
          ...
          <form className="bg-secondary/40 p-10 lg:p-14 border-t lg:border-t-0 lg:border-l border-border/60">
            <div className="space-y-5">
              <div>
                ...
                <input
                  type="text"
                  className="mt-2 w-full bg-card border border-border rounded-xl px-4 py-3 focus:outline-none focus:border-primary transition-colors"
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  className="mt-2 w-full bg-card border border-border rounded-xl px-4 py-3 focus:outline-none focus:border-primary transition-colors resize-none"
