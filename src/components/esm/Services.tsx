...
const services = [
  {
    ...
    desc: "Analyse approfondie de votre situation par notre comité médical et orientation vers la spécialité adaptée.",
  },
  {
    icon: FileText,
    title: "Préparation du dossier",
    desc: "Constitution rigoureuse du dossier médical, traduction et transmission aux établissements partenaires.",
  },
  {
    icon: Plane,
    title: "Organisation du voyage",
    desc: "Visa, billets d'avion, hébergement, transferts : tout est anticipé pour un déplacement serein.",
  },
  {
    icon: Users,
    title: "Assistance sur place",
    desc: "Un coordinateur et un traducteur vous accompagnent à chaque rendez-vous et durant l'hospitalisation.",
  },
  {
    icon: HeartPulse,
    title: "Suivi post-traitement",
    desc: "Continuité des soins, télémédecine et coordination avec vos médecins traitants à votre retour.",
  },
];
        ...
        <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s, i) => (
            ...
            >
              ...
              <span className="absolute top-6 right-6 text-xs text-muted-foreground/60 font-mono">
                0{i + 1}
              </span>
            </article>
          ))}
